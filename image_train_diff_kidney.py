...
def main():
    ...
    exp_name = f"kidney_learn_sigma_{args.rrdb_blocks}_{args.lr}_{args.batch_size}_{args.diffusion_steps}_{args.weight_decay}_{args.n_gen}_{MPI.COMM_WORLD.Get_rank()}"
    ...
    if args.soft_label_training:
        ...
        args.number_of_annotators = KidneyDataset.get_number_of_annotators()
    ...
    logger.log(f"gpu {MPI.COMM_WORLD.Get_rank()} / {MPI.COMM_WORLD.Get_size()} validation images {len(kidney_dataset)}")
