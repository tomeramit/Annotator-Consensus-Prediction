...
from datasets.brain_tumor import BrainTumor3Dataset
...
def main():
    ...
    exp_name = f"brain_tumor_3_learn_sigma_erosion_floating_p_{args.rrdb_blocks}_{args.lr}_{args.batch_size}_{args.diffusion_steps}_{str(args.dropout)}_{args.weight_decay}_{args.n_gen}_{MPI.COMM_WORLD.Get_rank()}"
    ...
    if args.soft_label_training:
        ...
        args.number_of_annotators = BrainTumor3Dataset.get_number_of_annotators()
    ...
    data = load_data(
        dataset_class=BrainTumor3Dataset,
    ...
    brain_dataset = BrainTumor3Dataset(
        mode='val',
        image_size=args.image_size,
