...
def main():
    ...
    exp_name = f"brain_growth_learn_sigma_erosion_floating_p_{args.rrdb_blocks}_{args.lr}_{args.batch_size}_{args.diffusion_steps}_{str(args.dropout)}_{args.weight_decay}_{args.n_gen}_{MPI.COMM_WORLD.Get_rank()}"
    ...
    if args.soft_label_training:
        ...
        args.number_of_annotators = BrainGrowthDataset.get_number_of_annotators()
    ...
    data = load_data(
        dataset_class=BrainGrowthDataset,
    ...
    brain_dataset = BrainGrowthDataset(
        mode='val',
        image_size=args.image_size,
